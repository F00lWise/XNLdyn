...
if __name__ == '__main__':
    ...
    ### Solve Main problem
    sol = solve_ivp(sim.time_derivative, t_span=[-20, 100], \
                    dense_output=True, y0=PAR.state_vector_0.flatten(), method='RK45', rtol=1e-10, atol=1e-10)
    ...
    fig, axes = plt.subplots(2, 2, figsize=(4, 7))
    plt.sca(axes[0,0])
