...
def run_modified_simulation(PAR, sim_options, changed_parameters, new_values, debug=False, save_tables = False):
    ...
    sim = XNLdyn.XNLsim(PAR, load_tables=False, save_tables=save_tables)
    sim.DEBUG = debug
    # run it!
